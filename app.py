...
#
# Используемые модели:
# 1) Stable Diffusion v1.5 (runwayml)
#    - Генерация базового изображения по текстовому описанию
#
# 2) Zero123++ (sudo-ai)
#    - Генерация новых ракурсов объекта
#    - Используется азимутальное вращение (30°, 90°, 150°)
#
# Интерфейс:
# - Streamlit
# - Поддержка CUDA (GPU обязателен для нормальной работы)
#
# Назначение:
# - Быстрый прототип генерации изображений
# - Подготовка данных для 3D / multi-view задач
# ============================================================

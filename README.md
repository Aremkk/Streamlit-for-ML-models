...
Полученные изображения демонстрируют возможность использования diffusion-моделей для:
- генерации визуального контента по тексту
- создания multi-view данных
- подготовки входных данных для 3D / NeRF / CV пайплайнов
